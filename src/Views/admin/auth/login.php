...
<head>
    <meta charset="utf-8">
    <title>TAXI Booking - Sign In</title>
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="<?php echo htmlspecialchars($appUrl); ?>" class="" target="_blank">
                                <h4 class="text-primary">TAXI Booking</h4>
                            </a>
                            <h3>Sign In</h3>
                        </div>
                        <?php if (!empty($errors)): ?>
                        ...
                        <form action="/admin/login" method="POST">
                            <div class="form-floating mb-3">
                                <input type="email" class="form-control" id="email" name="email" placeholder="name@example.com" value="<?php echo htmlspecialchars($oldInput['email'] ?? ''); ?>">

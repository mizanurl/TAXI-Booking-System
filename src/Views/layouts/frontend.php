...
<head>
    ...
    <!-- Custom styles for the suggestion list to override Bootstrap defaults -->
    <style>
        .autocomplete-results {
            position: absolute;
            z-index: 1050;
            /* Higher z-index to ensure visibility above most Bootstrap components */
            width: 100%;
            max-height: 400px;
            overflow-y: auto;
        ...
        /* Custom styling to fix the form-floating label overlap with icons */
...
<body>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a href="" class="navbar-brand p-0">
                    <h1 class="display-6 text-primary"><i class="fas fa-car-alt me-3"></i></i>TAXI Booking</h1>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        <a href="javascript:void(0);" class="nav-item nav-link">Pickup Location</a>
                        <a href="javascript:void(0);" class="nav-item nav-link">Reservation</a>
                        <a href="javascript:void(0);" class="nav-item nav-link">Fleets</a>
                        <a href="javascript:void(0);" class="nav-item nav-link">Contact</a>
                    </div>
                    <a href="javascript:void(0);" class="btn btn-primary rounded-pill py-2 px-4">Book Now</a>
                </div>
            </nav>
        </div>
    </div>
    ...
    <!-- Content Section - This is where individual page content will be injected -->
    <?php echo $content; ?>
